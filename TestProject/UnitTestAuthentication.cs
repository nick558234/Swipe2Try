...
namespace TestProject
{
    ...
    public class UnitTestAuthentication
    {
        ...
        public async Task LoginUserAsync_ShouldSucceed_WithValidCredentials()
        {
            ...
            var hashedPassword = Convert.ToBase64String(System.Security.Cryptography.SHA256.HashData(System.Text.Encoding.UTF8.GetBytes(password)));
            var user = new User
            {
                UserID = "user123",
                Name = "John Doe",
        ...
        public async Task LoginUserAsync_ShouldFail_WithIncorrectPassword()
        {
            ...
            var hashedPassword = Convert.ToBase64String(System.Security.Cryptography.SHA256.HashData(System.Text.Encoding.UTF8.GetBytes(correctPassword)));
